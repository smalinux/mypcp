...
const ProcessFieldData Process_fields[LAST_PROCESSFIELD] = {
   ...
   [PERCENT_MEM] = { .name = "SMA PERCENT_MEM", .title = "MEM% ", .description = "Percentage of the memory the process is using, based on resident memory size", .flags = 0, .defaultSortDesc = true, },
